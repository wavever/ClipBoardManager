...
extension L10n {
    static let zh: [String: String] = [
        ...
        "common.tagSearch": "用空格分隔多个标签…",
        "common.searchMode.tag": "标签",
        "common.searchHint.tooltip": "切换到「标签」模式可用空格分隔多个标签；其他模式下输入 # 也可按标签筛选。「任一 / 全部」匹配方式可在 设置 → 过滤 中调整。",
    ...
    static let en: [String: String] = [
        ...
        "common.tagSearch": "Separate multiple tags with spaces…",
        "common.searchMode.tag": "Tag",
        "common.searchHint.tooltip": "Switch to Tag mode to separate multiple tags with spaces; in other modes, type # to filter by tag. Change Any / All matching in Settings → Filters.",
